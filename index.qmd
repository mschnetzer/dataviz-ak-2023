...
- Folgt der R-Community auf Twitter für Inspiration, z.B. [Cédric Scherer](https://twitter.com/CedScherer), [Georgios Karamanis](https://twitter.com/geokaramanis), [Tanya Shapiro](https://twitter.com/tanya_shapiro), u.v.m.
...
::: {.column width="30%"}
<a href="data/workshop.R"><i class="fa-solid fa-code"></i></a>
...
:::
:::{.column width="30%"}
<a href="data/gdp.RData"><i class="fa-solid fa-file-arrow-down"></i></a>
